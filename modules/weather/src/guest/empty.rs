...
pub fn empty_capability_state(surface_id: SurfaceId) -> Surface {
    Surface::new(
        EmptyState::new()
            .title("i18n:capability.openWeather.fallback")
            .description("i18n:capability.openWeather.byok.fallback")
            .icon("cloud-off")
            .child(
                Text::new()
