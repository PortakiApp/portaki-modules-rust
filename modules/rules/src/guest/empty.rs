...
pub fn empty_content_state(surface_id: &str) -> Surface {
    Surface::new(
        EmptyState::new()
            .title(json!("i18n:home.card.empty.title"))
            .description(json!("i18n:home.card.empty.description"))
            .icon(json!("scale"))
            .child(
                Text::new()
                    .text(json!("i18n:home.card.empty.hint"))
                    .variant(json!("body")),
            ),
    )
    .with_id(surface_id)
...
pub fn empty_runtime_error_state(surface_id: &str) -> Surface {
    Surface::new(
        EmptyState::new()
            ...
            .child(
                Text::new()
                    .text(json!("i18n:home.card.error.hint"))
                    .variant(json!("body")),
            ),
    )
    .with_id(surface_id)
...
pub fn log_render_failure(surface_id: &str, error: &PortakiError) {
    ...
    let _ = log::error("rules_guest_render_failed", &fields);
}
